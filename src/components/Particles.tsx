...
const Particles = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 25; i++) {
      ...
      const size = Math.random() * 8 + 3 //3-1, 1.5-0.5, 5-2,Tamaño: 1px a 4px
      ...
      particle.style.backgroundColor = "#eCeC48"
      particle.style.boxShadow = `0 0 ${size * 3}px rgba(68, 85, 217, ${opacity})`
