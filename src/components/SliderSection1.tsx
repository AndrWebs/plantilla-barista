  ...
  return (
    <section className="py-20 px-6 relative overflow-hidden bg-stone-950">
      ...
      <div className="absolute inset-0 bg-gradient-to-b 
                      from-stone-900 via-transparent to-stone-950" />
                  ...
                  <div className="relative z-10 p-6 md:p-8 flex flex-col 
                    ...
                    <motion.div
                      ...
                      className="bg-orange-100/10 
                                 ...
                                 border-amber rounded-4xl p-2 md:p-2 shadow-4xl"
                    >
                      <motion.span
