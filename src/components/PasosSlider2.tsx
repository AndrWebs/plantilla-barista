...
const SliderPasos = () => {
  ...
  useEffect(() => {
    ...
    }, 10000) // ← cambia aquí la velocidad (5000 = 5 segundos)
  ...
  return (
    <section className="py-20 px-6 relative overflow-hidden bg-stone-950">
      <div className="max-w-5xl mx-auto relative z-10">
        {/* Encabezado opcional (puedes eliminarlo si quieres solo el slider) */}
        <motion.div
        ...
        <div
          className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[16/9] max-h-[500px]"
        ...
        >
          ...
          {/* Flechas laterales (opcional, puedes eliminarlas si solo quieres el botón central) */}
          <button
            onClick={prevSlide}
